...
?>
    ...
    <section class="new-website py-5">
        ...
        <p class="text-center mt-4">Feel like new with our massages and professional<br> therapist</p>
    </section>
                      ...
                      <div class="card">
                          <a href="product.php?product=<?php echo $products['id']; ?>">
                              ...
                              <div class="card-block">
                                  ...
                                  <p class="price text-center mb-2">$ <?php echo $products['price']; ?></p>
                              </div>
                          </a>
                      </div> <!--.card-->
                  </div> <!--col-6 col-md-3-->
